...
export const CardHeader = styled.View`
  flex-direction: row;
  align-items: center;
  /* color: ${(props) => (props.start ? '#82BF18' : '#4d85ee')}; */
  margin-bottom: 5px;
`;
...
export const DateHorizontal = styled.View`
  align-self: stretch;
  flex-direction: row;
...
export const DateVertical = styled.View`
  align-self: stretch;
  width: 50%;
  flex-direction: column;
...
export const ProblemButton = styled(Button).attrs({
  color: '#E74040',
})`
  align-self: stretch;
  margin-bottom: 3px;
